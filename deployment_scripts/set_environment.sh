...
export SIRMIONE_ALIAS=vn5819sirmione
export LIMONE_ALIAS=vn5819limone
export SCORPIO_ALIAS=vn5819scorpio
export VIRGO_ALIAS=vn5819virgo
export LIBRA_ALIAS=vn5819libra
export ZODIAC_ALIAS=vn5819zodiac
export DB_ADMIN_USER=vn5819
...
export ZODIAC_INSTANCE=vishalnc
